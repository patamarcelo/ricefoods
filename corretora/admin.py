...
class ClienteAdmin(admin.ModelAdmin):
    list_display = ('nome_fantasia','cpf_cnpj','get_insc','cidade','ativo','get_modificado','dias_descarga','veiculos_dia','descarga_sabado','recebe_nf','color')
    fieldsets = (
        ('Situação', {
            'fields': ('ativo',)
        }),
...
class CargaAdmin(SimpleHistoryAdmin):
    ...
    ('Nota Fiscal', {
            'fields': ('nota_fiscal_arquivo','nota_fiscal_xml','obs_email_nf')
        }),
    )
    raw_id_fields = ('pedido', 'fatura_frete_terceiros')
    ...
    history_list_display = ["situacao","ordem","get_data","peso","agendamento","notafiscal","pedido","motorista","placa","obs","valornf","valor_mot","comi_frete_ton","comi_frete_total",'fatura_frete_terceiros','nota_fiscal_arquivo','nota_fiscal_xml','obs_email_nf',"changed_fields"]
